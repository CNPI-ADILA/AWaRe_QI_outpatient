# Dental Infections Analysis Shiny Module - CORRECTED Implementation
# This module matches the baseline R Markdown code exactly

# Overview Tab UI
dentOverviewUI <- function(id) {
  ns <- NS(id)
  ...
  tagList(
    ...
    conditionalPanel(
      ...
      fluidRow(
        column(10, offset = 1,
               box(width = 12, title = "🎯 AWaRe Quality Indicators for Dental Infections", status = "info", solidHeader = TRUE,
                   h5("Within the gPPS data structure, the following antibiotic use quality indicators have been identified:"),
                   p("1) Proportion of patients presenting with dental infections given an oral antibiotic."),
                   p("2) Proportion of patients presenting with dental infections given oral antibiotics by AWaRe category (Access or Watch)."),
                   p("3) Proportion of patients presenting with dental infections prescribed the total daily dose of oral antibiotics recommended in the WHO AWaRe Antibiotic Book."),
                   p("4) Proportion of patients presenting with dental infections given the duration in days of oral antibiotics recommended in the WHO AWaRe Antibiotic Book.")
               )
        )
      ),
...
dentOralUI <- function(id) {
  ...
  tagList(
    ...
    conditionalPanel(
      ...
      fluidRow(
        column(10, offset = 1,
               box(width = 12, title = "📌 Indicator 1 - Oral Antibiotic Use", status = "primary", solidHeader = TRUE,
                   p("Proportion of patients presenting with dental infections given an oral antibiotic.")
               )
        )
      ),
      ...
      fluidRow(
        column(10, offset = 1,
               box(width = 12, title = "📈 Antibiotic Use by Route of Administration", status = "primary", solidHeader = TRUE,
                   p("This visual summarises the proportion of adult outpatients with dental infections given antibiotics by route of administration across specialties."),
      ...
      fluidRow(
        column(10, offset = 1,
               box(width = 12, title = "📝 Summary of Antibiotic Use for Dental Infections by Route of Administration", status = "success", solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
...
dentAWaReUI <- function(id) {
  ...
  tagList(
    ...
    conditionalPanel(
      ...
      fluidRow(
        column(10, offset = 1,
               box(width = 12, title = "📌 Indicator 2 - Oral Antibiotic Use by AWaRe", status = "primary", solidHeader = TRUE,
                   p("Proportion of patients presenting with dental infections given oral antibiotics by AWaRe category (Access or Watch).")
               )
        )
      ),
      ...
      fluidRow(
        column(10, offset = 1,
               box(width = 12, title = "📈 Antibiotic Prescription by AWaRe Classification", status = "primary", solidHeader = TRUE,
                   p("This visual summarises the proportion of adult outpatients with dental infections given antibiotics by AWaRe classification across specialties."),
                   div(style = "display: flex; justify-content: center; align-items: center; max-width: 100%; overflow: hidden;",
      ...
      fluidRow(
        column(10, offset = 1,
               box(width = 12, title = "📝 Summary of Antibiotic Use for Dental Infections by AWaRe Classification", status = "success", solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
...
dentChoiceUI <- function(id) {
  ...
  tagList(
    ...
    conditionalPanel(
      ...
      fluidRow(
        column(10, offset = 1,
               box(width = 12, title = "📌 Antibiotic Choice Alignment with AWaRe Book Recommendations for Dental Infections", status = "primary", solidHeader = TRUE,
                   p("Proportion of patients presenting with dental infections prescribed the recommended oral antibiotic choice in the WHO AWaRe Antibiotic Book.")
               )
        )
      ),
      ...
      fluidRow(
        column(10, offset = 1,
               box(width = 12, title = "🔍 WHO AWaRe Book Recommendation:", status = "primary", solidHeader = TRUE,
                   tags$p(strong("For Mild and Moderate Cases:")),
                   tags$ul(
                   ...
                   tags$p(strong("For the treatment of infections of dental soft tissues:")),
                   tags$ul(
                     tags$li(strong("Metronidazole"), " is an option")
                   ),
                   tags$p(strong("Duration:")),
                   tags$ul(
                     tags$li("If adequate source control achieved: ", strong("3 days")),
                     tags$li("If adequate source control not achieved: ", strong("5 days"))
                   )
               )
        )
      ),
      ...
      fluidRow(
        column(10, offset = 1,
               box(
                 ...
                 title = tagList(
                   icon("chart-bar"), 
                   " Antibiotic Choice Alignment Analysis for Dental Infections"
                 ), 
                 status = "primary", 
                 solidHeader = TRUE,
                 tabsetPanel(
                   ...
                   tabPanel(
                     ...
                     div(
                       ...
                       br(),
                       p("This visual summarises the proportion of adult outpatients with dental infections prescribed the recommended oral antibiotic choice in the WHO AWaRe Antibiotic Book across specialties."),
                       div(
                         style = "
                           display: flex; 
                   ...
                   tabPanel(
                     ...
                     div(
                       style = "background-color: white; padding: 15px;",
                       br(),
                       p("This visual shows the distribution of recommended oral antibiotics for dental infections by WHO AWaRe classification."),
                       div(
                         style = "
                           display: flex; 
                           justify-content: center; 
      ...
      fluidRow(
        column(10, offset = 1,
               box(width = 12, title = "📝 Summary of Antibiotic Choice Appropriateness for Dental Infections", status = "success", solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
...
dentDosageUI <- function(id) {
  ...
  tagList(
    ...
    conditionalPanel(
      ...
      fluidRow(
        column(10, offset = 1,
               box(width = 12, title = "📌 Indicator 3 – Oral Antibiotic Choice & Dosage Appropriateness", status = "primary", solidHeader = TRUE,
                   p("Proportion of patients presenting with dental infections prescribed the total daily dose of oral antibiotics recommended in the WHO AWaRe Antibiotic Book.")
               )
        )
      ),
      ...
      fluidRow(
        column(10, offset = 1,
               box(width = 12, title = "📈 Antibiotic Choice & Dosage Appropriateness for Dental Infections", status = "primary", solidHeader = TRUE,
                   p("This visual summarises the proportion of adult outpatients with dental infections prescribed the total daily dose of oral antibiotics recommended in the WHO AWaRe Antibiotic Book across specialties."),
                   div(style = "display: flex; justify-content: center; align-items: center; max-width: 100%; overflow: hidden;",
      ...
      fluidRow(
        column(10, offset = 1,
               div(class = "info-box",
                   style = "background-color: #f8f9fa; padding: 15px; border-left: 5px solid #17a2b8; border-radius: 5px; margin-top: 15px;",
                   strong("💡 Note:"),
                   " Metronidazole is included as an option for the treatment of dental soft tissue infections in the WHO AWaRe Book; however, due to the absence of specific dosage and duration recommendations, it was excluded from dosage and duration analysis."
               )
        )
      ),
      ...
      fluidRow(
        column(10, offset = 1,
               box(width = 12, title = "📝 Summary of Antibiotic Choice & Dosage Appropriateness for Dental Infections", status = "success", solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
...
dentDurationUI <- function(id) {
  ...
  tagList(
    ...
    conditionalPanel(
      ...
      fluidRow(
        column(10, offset = 1,
               box(width = 12, title = "📌 Indicator 4 – Oral Antibiotic Duration Appropriateness", status = "primary", solidHeader = TRUE,
                   p("Proportion of patients presenting with dental infections given the duration in days of oral antibiotics recommended in the WHO AWaRe Antibiotic Book.")
               )
        )
      ),
      ...
      fluidRow(
        column(10, offset = 1,
               box(width = 12, title = "📈 Antibiotic Duration Appropriateness for Dental Infections", status = "primary", solidHeader = TRUE,
                   p("This visual summarises the proportion of adult outpatients with dental infections given the duration in days of oral antibiotics recommended in the WHO AWaRe Antibiotic Book across specialties."),
                   div(style = "display: flex; justify-content: center; align-items: center; max-width: 100%; overflow: hidden;",
      ...
      fluidRow(
        column(10, offset = 1,
               box(width = 12, title = "📝 Summary of Antibiotic Duration Appropriateness for Dental Infections", status = "success", solidHeader = TRUE, collapsible = TRUE, collapsed = TRUE,
...
# Module Server - Handles all dental infection tabs
dentAnalysisServer <- function(id, data_reactive) {
  moduleServer(id, function(input, output, session) {
    ...
    generate_eligibility_feedback <- function() {
      tryCatch({
        ...
        # Filter eligible dental infection patients
        data_DENT <- data_patients %>%
          filter(`Diagnosis code` == "DENT") %>%
          mutate(
            Route = toupper(as.character(Route)),
            AWaRe_compatible = (`Patient age group` == "ADULT")
          ) 
        
        # Count eligible unique dental cases
        eligible_DENT_n <- data_DENT %>%
          filter(AWaRe_compatible) %>%
          distinct(`Unique Patient ID`) %>%
          nrow()
        
        # Build status message
        status_message <- if(eligible_DENT_n == 0) {
        ...
        html_feedback <- HTML(paste0(
          ...
          "This script applies <strong>WHO AWaRe Quality Indicators</strong> to adult outpatients with dental infections.",
          "</p>",
          "<ul>",
          "<li><strong>gPPS recorded symptoms:</strong> Toothache/gum swelling</li>",
          "<li><strong>Total eligible cases:</strong> ", eligible_DENT_n, "</li>",
          "</ul>",
          status_message,
          "</div>"
        ))
    ...
    output$summary_insights_cards <- renderUI({
      ...
      # Calculate totals
      total_DENT <- data_patients %>%
        filter(`Diagnosis code` == "DENT") %>%
        distinct(`Unique Patient ID`) %>%
        nrow()
      
      total_DENT_adults <- data_patients %>%
        filter(`Diagnosis code` == "DENT", `Patient age group` == "ADULT") %>%
        distinct(`Unique Patient ID`) %>%
        nrow()
      
      total_DENT_adults_abx <- data_patients %>%
        filter(`Diagnosis code` == "DENT", `Patient age group` == "ADULT", AWaRe %in% AWaRe_abx) %>%
        distinct(`Unique Patient ID`) %>%
        nrow()
      
      total_DENT_adults_prescriptions <- data_patients %>%
        filter(`Diagnosis code` == "DENT", `Patient age group` == "ADULT", AWaRe %in% AWaRe_abx) %>%
        nrow()
      ...
      insight_cards <- HTML(glue::glue(
        ...
        <div style='flex: 1; min-width: 250px; background-color: #e6f4ea; border-left: 6px solid #009E73; padding: 12px; border-radius: 5px;'>
          <strong>Eligible Patients with Dental Infections (Adults):</strong><br>
          <span style='font-size: 1.3em;'>{total_DENT_adults}</span><br>
          <small>{round(100 * total_DENT_adults / total_DENT, 1)}% (of {total_DENT} patients with dental infections)</small>
        </div>
        ...
        <div style='flex: 1; min-width: 250px; background-color: #fff3cd; border-left: 6px solid #D55E00; padding: 12px; border-radius: 5px;'>
          ...
          <span style='font-size: 1.3em;'>{round(100 * total_DENT_adults_abx / total_DENT_adults, 1)}%</span><br>
          <small>({total_DENT_adults_abx} of {total_DENT_adults} eligible patients)</small>
        </div>
        ...
        <div style='flex: 1; min-width: 250px; background-color: #f0f8ff; border-left: 6px solid #0072B2; padding: 12px; border-radius: 5px;'>
          ...
          <span style='font-size: 1.3em;'>{total_DENT_adults_prescriptions}</span>
        </div>
    ...
    output$patient_level_table <- DT::renderDataTable({
      ...
      patient_summary <- data.frame(
        Category = c(
          "Number of all patients with a diagnosis of dental infections",
          "Number of adult patients (≥18 years) with dental infections",
          "Number of eligible patients: Adult patients with dental infections who received antibiotics"
        ),
        Count = c(
          total_patients,
          data_patients %>%
    ...
    output$prescription_level_table <- DT::renderDataTable({
      ...
      prescription_summary <- data.frame(
        Category = c(
          "Number of all antibiotic prescriptions for patients diagnosed with dental infections",
          "Number of antibiotic prescriptions for adult patients with dental infections",
          "Number of eligible antibiotic prescriptions"
        ),
        Count = c(
          total_prescriptions,
          data_patients %>% filter(`Diagnosis code` == "DENT", `Patient age group` == "ADULT") %>% nrow(),
          data_patients %>% filter(`Diagnosis code` == "DENT", `Patient age group` == "ADULT", AWaRe %in% AWaRe_abx) %>% nrow()
        )
      ) %>%
        mutate(
    ...
    oral_data_reactive <- reactive({
      ...
      oral_summary_by_spec <- DENT_oral_summary %>%
      ...
      oral_summary_total <- DENT_oral_summary %>%
        summarise(
    ...
    output$oral_summary <- renderUI({
      ...
      data_DENT <- oral_data$data_DENT
      
      # Denominator
      total_eligible <- data_DENT %>%
        filter(`Patient age group` == "ADULT") %>%
        distinct(`Unique Patient ID`) %>%
        nrow()
      
      total_eligible_with_abx <- data_DENT %>%
      ...
      intro_text <- glue::glue(
        ...
        💊 <strong>Denominator:</strong> Number of eligible patients presenting with dental infections (<strong>{total_eligible_with_abx}</strong> out of {total_eligible}).
        </div><br><br>
    ...
    output$oral_plot <- renderPlotly({
      ...
      plt <- ggplotly(p, tooltip = "text") %>%
        layout(
          title = list(
            text = "<b>Proportion of Patients with Dental Infections by Antibiotic Route</b>",
            x = 0.5,
            xanchor = "center",
            y = 0.98,
            yanchor = "top",
    ...
    output$aware_summary <- renderUI({
      ...
      data_DENT <- aware_data$data_DENT
      
      # Denominator
      total_eligible2 <- data_DENT %>%
        filter(`Patient age group` == "ADULT") %>%
        distinct(`Unique Patient ID`) %>%
        nrow()
      
      total_eligible_with_abx2 <- data_DENT %>%
      ...
      intro_text2 <- glue::glue(
        "<div style='background-color: #f8f9fa; border-left: 5px solid #17a2b8; padding: 14px; margin-top: 10px; margin-bottom: 10px;'>
        💊 <strong>Denominator:</strong> Number of eligible patients who received any oral antibiotic for dental infections (<strong>{total_eligible_with_abx2}</strong> out of {total_eligible2}).
        </div><br><br>
        <strong>Summary:</strong><br><br>"
      )
    ...
    output$aware_plot <- renderPlotly({
      ...
      plt <- ggplotly(p, tooltip = "text") %>%
        layout(
          title = list(
            text = "<b>Distribution of Oral Antibiotic Use in Dental Infections by AWaRe Category</b>",
            x = 0.5,
            xanchor = "center",
            y = 0.98,
            yanchor = "top",
    ...
    choice_data_reactive <- reactive({
      ...
      # Prepare the data
      data_DENT_choice <- data_patients %>%
        filter(`Diagnosis code` == "DENT") %>%
        mutate(
          Route = toupper(Route),
      ...
      # CORRECTED: Lookup ABX codes using ATC5
      lookup_names <- data_lookup %>%
        filter(Code == "PC_DENT_APPROP_DOSAGE_ORAL_ABX") %>%
        select(starts_with("ABX-ATC")) %>%
        unlist(use.names = FALSE)
      
      # CORRECTED: Flag matched prescriptions using ATC5
      data_DENT_choice <- data_DENT_choice %>%
        mutate(
          Drug_Match = ATC5 %in% lookup_names
        )
      
      # Extract lookup info
      lookup_DENT <- data_lookup %>%
        filter(Code == "PC_DENT_APPROP_DOSAGE_ORAL_ABX")
      
      # CORRECTED: Create long format from lookup using ATC
      lookup_long <- tibble(
        Drug = unlist(lookup_DENT %>% select(starts_with("ABX-ATC")), use.names = FALSE),
        Choice = unlist(lookup_DENT %>% select(starts_with("ABX-CHOICE")), use.names = FALSE)
      ) %>%
        filter(!is.na(Drug))
      
      # CORRECTED: Merge choice info with patient-level data using ATC5
      data_DENT_choice <- data_DENT_choice %>%
        left_join(lookup_long, by = c("ATC5" = "Drug"))
      
      # Patient Summary
      patient_summary <- data_DENT_choice %>%
        filter(AWaRe_compatible) %>%
        group_by(`Unique Patient ID`, `Type of specialty`) %>%
        summarise(
          All_ABX = list(unique(ATC5)),
          
          # Match flags for up to 3 drugs
      ...
      no_abx_patients <- data_DENT_choice %>%
        group_by(`Unique Patient ID`, `Type of specialty`) %>%
        summarise(
      ...
      not_eligible_patients <- data_DENT_choice %>%
        group_by(`Unique Patient ID`, `Type of specialty`) %>%
      ...
      # Combine
      qi_summary_DENT <- bind_rows(qi_summary_DENT, hospital_data)
      
      # Recalculate totals
      qi_summary_DENT <- qi_summary_DENT %>%
        group_by(`Type of specialty`) %>%
        mutate(
          Total = sum(Patients),
    ...
    output$choice_plot <- renderPlotly({
      ...
      qi_summary_DENT <- choice_data$qi_summary_DENT
      ...
      # Plot
      p <- ggplot(qi_summary_DENT, aes(x = PlotLabel, y = Proportion, fill = Indicator, text = hover_text)) +
        ...
        geom_text(
          data = qi_summary_DENT %>% distinct(PlotLabel, Total),
      ...
      plt <- ggplotly(p, tooltip = "text") %>%
        layout(
          title = list(
            text = "<b>Antibiotic Choice Alignment for Dental Infections</b>",
    ...
    output$choice_aware_plot <- renderPlotly({
      ...
      data_DENT_choice <- choice_data$data_DENT_choice
      patient_summary <- choice_data$patient_summary
      
      data <- data_reactive()
      data_lookup <- data$data_lookup
      
      # CORRECTED: Lookup names using ATC
      lookup_names <- data_lookup %>%
        filter(Code == "PC_DENT_APPROP_DOSAGE_ORAL_ABX") %>%
        select(starts_with("ABX-ATC")) %>%
        unlist(use.names = FALSE)
      
      # Patient summary by AWaRe - CORRECTED TO USE ATC5
      patient_summary_AWARE <- data_DENT_choice %>%
        filter(`Patient age group` == "ADULT", AWaRe %in% AWaRe_abx) %>%
    ...
    output$choice_summary <- renderUI({
      ...
      relevant_data <- qi_summary_DENT_filtered %>%
        filter(Indicator %in% c(
          "Received recommended oral antibiotics",
          "Partially received recommended oral antibiotics",
          "Received oral antibiotics not among recommended options"
      ...
      if (nrow(relevant_data) == 0) {
        return(HTML(
          ...
          ⚠️ <strong>No summary available</strong> — there are currently no eligible patients for assessing oral antibiotic choice appropriateness for dental infections.<br><br>
      ...
      # Summarise data
      summary_data_DENT <- relevant_data %>%
        group_by(`Type of specialty`, Indicator) %>%
        summarise(Patients = sum(Patients), .groups = "drop") %>%
        pivot_wider(
      ...
      hospital_row <- summary_data_DENT %>%
        summarise(
          `Type of specialty` = "Facility-Wide",
      ...
      # Combine
      summary_data_combined <- bind_rows(hospital_row, summary_data_DENT)
      
      # Intro
      intro_text <- glue::glue(
        "<div style='background-color: #f8f9fa; border-left: 5px solid #17a2b8; padding: 14px; margin-top: 10px; margin-bottom: 10px;'>
        💊 <strong>Denominator:</strong> Number of eligible patients who received any oral antibiotics for dental infections (<strong>{total_oral}</strong> out of {total_eligible}).
        </div><br><br>
        <strong>Summary:</strong><br><br>"
      )
    ...
    # Dosage data reactive - CORRECTED TO USE ATC5 and exclude Metronidazole by ATC code
    dosage_data_reactive <- reactive({
      ...
      # CORRECTED: Filter and prepare - EXCLUDE Metronidazole by ATC5 code
      data_DENT2 <- data_patients %>%
        filter(
          `Diagnosis code` == "DENT",
          ATC5 != "J01XD01"  # Metronidazole ATC code
        ) %>%
        mutate(
          Route = toupper(Route),
          AWaRe_compatible = ifelse(
      ...
      # Lookup - CORRECTED TO USE ABX-ATC
      lookup2 <- data_lookup %>% filter(Code == "PC_DENT_APPROP_DOSAGE_ORAL_ABX")
      lookup_names2 <- unlist(lookup2[1, c("ABX-ATC-1", "ABX-ATC-2")], use.names = FALSE)
      lookup_names2 <- toupper(trimws(lookup_names2))
      
      # Compute Total Daily Dose with MU → IU conversion
      data_DENT2 <- data_DENT2 %>%
        mutate(
      ...
      # Match Drug + Dose + Route - CORRECTED TO USE ATC5
      ...
      drug_names <- sapply(1:2, function(i) toupper(trimws(lookup2[[paste0("ABX-ATC-", i)]][1])))
      routes <- sapply(1:2, function(i) toupper(trimws(lookup2[[paste0("ABX-ROUTE-", i)]][1])))
      expected_doses <- sapply(1:2, get_expected_dose)
      
      # Special logic for Drug 2 (main + alt dose for Phenoxymethylpenicillin)
      ...
      # Perform matching - CORRECTED TO USE ATC5
      data_DENT2 <- data_DENT2 %>%
        mutate(
      ...
      # Patient summary - CORRECTED TO USE ATC5
      patient_summary2 <- data_DENT2 %>%
        filter(AWaRe_compatible) %>%
        group_by(`Unique Patient ID`, `Type of specialty`) %>%
        summarise(
    ...
    output$dosage_plot <- renderPlotly({
      ...
      plt <- ggplotly(p, tooltip = "text") %>%
        layout(
          title = list(
            text = "<b>Antibiotic Choice & Dosage for Dental Infections</b>",
            x = 0.5,
            xanchor = "center",
            y = 0.98,
            yanchor = "top",
    ...
    output$dosage_summary <- renderUI({
      ...
      final_summary2 <- dosage_data$final_summary2
      data_DENT2 <- dosage_data$data_DENT2
      
      # Filter
      final_summary2_DENT_filtered <- final_summary2 %>%
        filter(`Type of specialty` != "Facility-Wide")
      ...
      total_approp_oral_given <- final_summary2_DENT_filtered %>%
        filter(Dose_Result %in% dose_categories) %>%
        summarise(Total = sum(Patients, na.rm = TRUE)) %>%
        pull(Total)
      
      relevant_dose_data <- final_summary2_DENT_filtered %>%
        filter(Dose_Result %in% dose_categories)
    ...
    <strong>Summary:</strong><br><br>"
      ...
      if (nrow(complete_summary) == 0) {
        return(HTML(
          "<div style='background-color: #fff3cd; border-left: 5px solid #ffc107; padding: 14px; margin-top: 10px;'>
      ⚠️ <strong>No summary available</strong> — there are currently no eligible patients for evaluating the <strong>appropriateness of oral antibiotic dosage</strong> for dental infections.<br><br>
      <em>This may indicate that no patients met the inclusion criteria, or no patients received recommended oral antibiotics during the reporting period.</em>
      </div>"
        ))
      }
    ...
    # Duration data reactive - uses data_DENT2 which already excludes Metronidazole
    duration_data_reactive <- reactive({
      ...
      # Extract durations - CORRECTED TO USE ATC
      ...
      # Filter data - CORRECTED: Exclude Metronidazole by ATC code
      data_DENT4 <- data_patients %>%
        filter(
          `Diagnosis code` == "DENT",
          ATC5 != "J01XD01"  # Metronidazole ATC code
        ) %>%
      ...
      # Merge duration info - CORRECTED TO USE ATC5
      data_DENT4 <- data_DENT4 %>%
    ...
    output$duration_plot <- renderPlotly({
      ...
      plt <- ggplotly(p, tooltip = "text") %>%
        layout(
          title = list(
            text = "<b>Duration Appropriateness for Dental Infections</b>",
            x = 0.5,
            xanchor = "center",
            y = 0.98,
            yanchor = "top",
    ...
    output$duration_summary <- renderUI({
      ...
      duration_viz_data <- duration_data$duration_viz_data
      data_DENT4 <- duration_data$data_DENT4
      ...
      # Total eligible adult DENT patients (denominator total)
      total_eligible <- data_DENT4 %>%
        filter(`Patient age group` == "ADULT") %>%
        distinct(`Unique Patient ID`) %>%
        nrow()
